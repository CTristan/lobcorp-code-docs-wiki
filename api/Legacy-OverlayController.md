...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → OverlayController
...
### SetAnchorPivot(RectTransform, AnchorPivotPos)

```csharp
public static void SetAnchorPivot(RectTransform target, AnchorPivotPos pos)
```
