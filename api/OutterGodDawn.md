...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/CreatureBase) → [OutterGodOrdealCreature](/api/OutterGodOrdealCreature) → OutterGodDawn
