...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [SefiraBossBase](/api/SefiraBossBase) → [KetherBossBase](/api/KetherBoss-KetherBossBase) → KetherMiddleBossBase
